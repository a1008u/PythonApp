...
import test.DeleteNeo4j as clear
import test.Input_neo4j as input_neo4j
import test.InputFile as inputFile
...
if __name__ == '__main__':
    ...
    driver: Driver = GraphDatabase.driver('bolt://192.168.1.7:7687')
